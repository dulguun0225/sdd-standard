...
`specs/<NNN>-<kebab-slug>/` (§2.2). Each adopting team binds the
...
approval is a GitLab Premium feature), the checks still run. A red
pipeline is then a merge-blocker by convention — recorded honestly, per
